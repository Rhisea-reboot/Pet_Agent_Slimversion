...
inline const QString SEMANTIC_TOOL_CALLS = QStringLiteral("semantic.tool.calls");
inline const QString SEMANTIC_TOOL_TRACE = QStringLiteral("semantic.tool.trace");
...
inline const QString NODE_TYPE_TOOL_LOOP = QStringLiteral("tool.loop");
